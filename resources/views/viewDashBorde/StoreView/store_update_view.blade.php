...
<h1 style="text-align: center">{{$id}}</h1>
 ...
 <h1 style="text-align: center; background-color:green;color:#FFFFFF">update Store</h1>


<!-- naem of store -->
<form class="col-auto my-1" enctype="multipart/form-data" action="{{URL('store/update')}}" method="POST">
